 ...
 * @since 1.0.0
 */
public class PigHandler implements MessageListener { //手动回复实现ChannelAwareMessageListener监听接口 。自动回复，可实现MessageListener监听接口
    ...
    public void onMessage(Message message) {
        try {
            ...
            System.out.println("我是消费者1,我的id是" + jsonData.get("id").asText()
